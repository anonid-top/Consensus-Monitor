...
def parse_args():
    ...
    parser.add_argument(
        "--refresh-validators",
        type=float,
        help="Refresh validators every N second",
        required=False,
        default=30,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        help="Refresh upgrade plan every N second",
        required=False,
        default=60,
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--block-time-number",
        type=int,
        help="Number of the latest block to evaluate average block time",
        required=False,
        default=30,
    )
    ...
    parser.add_argument(
        "--columns",
        type=int,
        help="Number of columns in the main table",
        required=False,
        default=3,
    )
